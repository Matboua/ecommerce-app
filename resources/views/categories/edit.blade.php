...
@section('content')
    <section class="flex flex-col items-center pt-6">
        <div
            ...
            @endif
                <form class="space-y-4 md:space-y-6" method="POST" action="{{route('categories.update', $categorie->id)}}">
                    @method('put')
                    @csrf
                    <div>

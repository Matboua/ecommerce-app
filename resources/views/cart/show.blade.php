...
@section('content')
    ...
    <div class="font-[sans-serif] bg-gradient-to-tr from-gray-200 via-gray-100 to-gray-50 min-h-[calc(100vh-73px)]">
        <div class="max-w-7xl max-lg:max-w-4xl mx-auto p-6">
            ...
            <div class="grid lg:grid-cols-3 gap-4 relative mt-8">
                ...
                <div class="bg-white h-max rounded-md p-6 shadow-[0_0px_4px_0px_rgba(6,81,237,0.2)] sticky top-[93px]">

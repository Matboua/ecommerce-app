...
@endsection --}}
@section('cart')
    <a href="{{route('cart.show')}}"><i class="fa-solid fa-cart-plus fa-2xl text-white ml-8"></i></a>
@endsection
@section('content')
        <div class="grid grid-cols-4 px-20">
            {{-- Product Strat --}}
            @foreach ($products as $item)
            <div class="relative m-10 flex max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
                <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                    <img class="object-cover" src="{{url($item->image)}}" />
                ...
                <div class="mt-4 px-5 pb-5">
                    ...
                    <p>
                        ...
                        <span class="block text-sm text-slate-900 line-through">{{$item->price + 250}}</span>
                    </p>

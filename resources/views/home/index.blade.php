        ...
        <div
          ...
          <div class="mt-4 px-5 pb-5">
            ...
            <div class="mt-2 mb-5 flex items-center justify-between">
              <p>
                <span class="text-3xl dark:text-gray-200 font-bold text-slate-900">{{ $item->price }}</span>
                <span class="block text-sm dark:text-gray-200 text-slate-900 line-through">{{ $item->price + 250 }}</span>
              </p>
